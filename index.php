...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
  <div class="col-md-5 p-lg-5 mx-auto my-5">
    <h1 class="display-4 font-weight-normal">ChatRoom Made By ShivamTechCreator</h1>
    <p class="lead font-weight-normal">Chat with Friends with our family server</p>
  

    <form action="Claim.php" method="post">

    shivamtechchatroom.com/<input type="text" name="room">
